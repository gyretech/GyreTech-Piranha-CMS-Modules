...
public static class IdentityEFManagerModuleExtensions
{
    ...
    /// <returns></returns>
    public static IApplicationBuilder UsePiranhaIdentityEFManager(this IApplicationBuilder builder)
    {
        return builder.UseMiddleware<Piranha.AspNetCore.Identity.EF.Manager.ResourceMiddleware>();
        // return builder;
    }
}